...
void Create_Shapes(void){
Make_Poly(-0.5,0.5,2.0,1.0,.01,0.0,4,RED,SHADE_CENTER);
Make_Poly(0.0,0.5,2.0,1.0,.01,0.0,360,MULTI_COLORED,SHADE_CENTER);
Make_Poly(0.5,0.5,1.0,5.0,.01,0.0,10,RED_SHADED,SHADE_CENTER);
